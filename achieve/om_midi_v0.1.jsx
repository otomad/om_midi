	...
	while(offset < this.fileLength)
	{
		...
		if(chunkType == "MTrk")
		{
			...
			while(chunkOffset < chunkEnd)
			{
				...
				{
					seconds = ticks * this.microsecondsPerQuarterNote / this.timeDivision / 1000000;
...

{
	...
	function applyChannelToLayer(channel,layer,pb,totalNotesCount,notesSoFar)
	{
	...
	function applyMidiToLayer(midi,layer,totalNotesCount)
	{
