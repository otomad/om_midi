...
/**
 * The application object (Adobe Illustrator)
 */
 ...
 */
declare function alert(message: string | number | boolean, title?: string, errorIcon?: boolean): void
...
declare function localize(what: object, ...arguments: any[]): string
