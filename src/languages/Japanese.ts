...
const Japanese: typeof SChinese = {
	...
	midi_header_validation_error: "エラー: MIDI ファイル ヘッダーの検証に失敗しました (標準の MIDI ファイルではないか、ファイルが破損しています)。",
	...
	not_one_track_for_apply_effects_only_error: "エラー: エフェクトを適用すると、一度に 1 つのトラックしか選択できません。",
	end_of_track_position_error: "エラー: トラックの終了位置が間違っています。 期待される 0、実際には 1。",
