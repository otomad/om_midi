...
(function (thisObj) {
     ...
     * @returns 行栏目。
     */
    function addGroup(parent, name, type, params, properties, doNotSetLabelMinWidth) {
        //#region functions
    ...
    ***************************************************************************** */
    ...
    var SChinese = {
        ...
        invalid_duration_error: "错误：输入的“每个字幕持续时间”参数的值不合法。",
        empty_subtitles_error: "错误：请输入字幕内容。",
        batch_subtitle_generation: "字幕生成器",
        linear: "线性",
        hold_both: "定格两边",
        hold_in: "定格左边",
        hold_out: "定格右边",
    ...
    var Vietnamese = {
        ...
        file_unreadable_error: "Lỗi: Không thể đọc tệp. Tệp có thể đã bị chiếm dụng hoặc không tồn tại.",
        ...
        motion_for_horizontal_flip: "Motion cho hiệu ứng lật　",
        motion_entrance: "Vào",
        motion_exit: "Ra",
        ...
        invalid_duration_error: "Lỗi: Giá trị của thông số \"Thời lượng của mỗi phụ đề\" không hợp lệ.",
        empty_subtitles_error: "Lỗi: Vui lòng nhập nội dung phụ đề.",
    ...
    var Korean = {
        ...
        normalize_pan_to_100: "팬을 -100 ~ 100 으로 정규화",
        using_layering: "@빙구 앵내 의 독특한 레이어링 방식",
        ...
        file_unreadable_error: "오류: 파일을 읽을 수 없습니다. 파일이 이미 사용되었거나 존재하지 않을 수 있습니다.",
        ...
        invalid_duration_error: "오류: \"각 자막 재생 시간\" 매개변수의 값이 잘못되었습니다.",
        empty_subtitles_error: "오류: 자막 내용을 입력해주세요.",
        batch_subtitle_generation: "자막 생성",
        linear: "선의",
        hold_both: "양쪽 유지",
        hold_in: "왼쪽 유지",
        hold_out: "오른쪽 유지",
    ...
    var BaseTab = /** @class */ (function () {
        ...
        BaseTab.prototype.getCheckedChecks = function () {
            var checks = [];
            var children = this.group instanceof Group ? this.group.children : this.group.content.children;
            for (var _i = 0, children_1 = children; _i < children_1.length; _i++) {
                var check = children_1[_i];
    ...
    var ConfigJsonNS;
    (function (ConfigJsonNS) {
        var MappingVelocity = /** @class */ (function () {
            function MappingVelocity(literal) {
                this.velocityLess = 0;
                this.velocityMore = 127;
                this.targetLess = -192;
                this.targetMore = 0;
                if (literal)
                    assign(this, literal);
            }
            return MappingVelocity;
        }());
        ConfigJsonNS.MappingVelocity = MappingVelocity;
    })(ConfigJsonNS || (ConfigJsonNS = {}));
    var ConfigJsonNS$1 = ConfigJsonNS;
    ...
    var HasNoVideoError = /** @class */ (function (_super) {
        __extends(HasNoVideoError, _super);
        function HasNoVideoError() {
            return _super.call(this, localize(uiStr.has_no_video_error)) || this;
        }
        return HasNoVideoError;
    }(MyError));
    var InvalidMappingVelocityValuesError = /** @class */ (function (_super) {
        __extends(InvalidMappingVelocityValuesError, _super);
        function InvalidMappingVelocityValuesError() {
            return _super.call(this, localize(uiStr.invalid_mapping_velocity_values_error)) || this;
        }
        return InvalidMappingVelocityValuesError;
    }(MyError));
    var InvalidDurationError = /** @class */ (function (_super) {
        __extends(InvalidDurationError, _super);
        function InvalidDurationError() {
            return _super.call(this, localize(uiStr.invalid_duration_error)) || this;
        }
        return InvalidDurationError;
    }(MyError));
    var EmptySubtitlesError = /** @class */ (function (_super) {
        __extends(EmptySubtitlesError, _super);
        function EmptySubtitlesError() {
            return _super.call(this, localize(uiStr.empty_subtitles_error)) || this;
        }
        return EmptySubtitlesError;
    }(MyError));
    ...
    function setNumberEditText(editText, type, defaultValue) {
        editText.onChange = function () {
            ...
            if (type.type === "decimal") {
                regex = /-?\d+(\.\d+)?/g;
                if (type.min !== undefined && type.min >= 0)
                    regex = /\d+(\.\d+)?/g;
            }
            ...
            if (matches) {
                ...
                text || (text = "0");
                var num = type.type === "int" ? parseInt(text, 10) : parseFloat(text);
                if (isNaN(num))
                    num = (_a = defaultValue) !== null && _a !== void 0 ? _a : 0;
                if (type.max !== undefined && (type.maxNeq && num === type.max || num > type.max))
                    num = (_b = defaultValue) !== null && _b !== void 0 ? _b : type.max;
                if (type.min !== undefined && (type.minNeq && num === type.min || num < type.min))
                    num = (_c = defaultValue) !== null && _c !== void 0 ? _c : type.min;
                // 谨防写成 type.min && num < type.min。如果 type.min 刚好等于 0 的话会判定为假。
                text = String(num);
                if (text.indexOf("e") !== -1)
                    text = String(defaultValue !== null && defaultValue !== void 0 ? defaultValue : "");
            }
            else
                text = String(defaultValue !== null && defaultValue !== void 0 ? defaultValue : "");
            editText.text = text;
    ...
    var MappingVelocityDialog = /** @class */ (function () {
        function MappingVelocityDialog(targetName, targetRange, data) {
            var _a, _b;
            var _this = this;
            ...
            _a = this.addRow(uiStr.notes_velocity), this.velocityLessTxt = _a[0], this.velocityMoreTxt = _a[1];
            _b = this.addRow(targetName), this.targetLessTxt = _b[0], this.targetMoreTxt = _b[1];
            ...
            [this.velocityLessTxt, this.velocityMoreTxt].forEach(function (text) {
                return setNumberEditText(text, { type: "int", min: 0, max: 127 });
            });
            [this.targetLessTxt, this.targetMoreTxt].forEach(function (text) {
                return setNumberEditText(text, { type: "decimal", min: targetRange[0], max: targetRange[1] });
            });
        }
        MappingVelocityDialog.prototype.showDialog = function () {
            this.window.center();
            this.window.show();
        ...
        MappingVelocityDialog.prototype.addRow = function (name) {
            var characters = 6;
            var group = addGroup(this.group, localize(name), "group", { orientation: "row", alignment: ["right", "center"] }).control;
            var less = addControl(group, "edittext", { characters: characters });
            addControl(group, "statictext", { text: "~" });
            var more = addControl(group, "edittext", { characters: characters });
            return [less, more];
        };
        MappingVelocityDialog.prototype.getResult = function () {
            return new ConfigJsonNS$1.MappingVelocity({
    ...
    var MappingVelocityCheckbox = /** @class */ (function () {
        function MappingVelocityCheckbox(parent, targetText, targetRange, defaultRange, text) {
            var _this = this;
            this.value = false;
            this.parent = parent;
            this.targetRange = targetRange;
            this.mapping = new ConfigJsonNS$1.MappingVelocity({ targetLess: defaultRange[0], targetMore: defaultRange[1] });
            this.group = addControl(parent, "group", { orientation: "row" });
            this.checkbox = addControl(this.group, "checkbox", { text: text });
            this.advanceBtn = addControl(this.group, "button", { text: DIALOG_SIGN, size: [MIDI_BUTTON_WIDTH, 18] });
            this.checkbox.onClick = function () { return _this.value = _this.checkbox.value; };
            this.advanceBtn.onClick = function () {
                var result = new MappingVelocityDialog(targetText, targetRange, _this.mapping).showDialog();
                if (result)
                    _this.mapping = result;
            };
        }
        MappingVelocityCheckbox.prototype.setEnabled = function (enabled) {
            this.checkbox.enabled = this.advanceBtn.enabled = enabled;
            if (!enabled)
                this.value = this.checkbox.value = false;
        };
        MappingVelocityCheckbox.prototype.map = function (value) {
        ...
        return MappingVelocityCheckbox;
    }());
    ...
    var ApplyEffectsTab = /** @class */ (function (_super) {
        ...
        function ApplyEffectsTab(parent) {
            ...
            _this.vFlip = _this.addCheckbox();
            _this.ccwFlip = _this.addCheckbox();
            _this.cwFlip = _this.addCheckbox();
            _this.hMirror = _this.addCheckbox();
            _this.ccwRotation = _this.addCheckbox();
            _this.cwRotation = _this.addCheckbox();
            _this.negative = _this.addCheckbox();
            _this.mapVelToOpacity = new MappingVelocityCheckbox(_this.group.content, uiStr.opacity, [0, 100], [0, 100]);
            ...
            _this.mapVelToVolume = new MappingVelocityCheckbox(_this.group.content, uiStr.audio_levels, [-192, 12], [-40, 0]);
            _this.mapVelToVolume.group.margins = [0, 7, 10, 0];
            var flips = [_this.hFlip, _this.vFlip, _this.ccwFlip, _this.cwFlip];
            var _loop_1 = function (flip) {
                flip.onClick = function () {
                    for (var _i = 0, flips_2 = flips; _i < flips_2.length; _i++) {
                        var otherFlip = flips_2[_i];
                        if (otherFlip !== flip)
                            otherFlip.value = false;
                    }
                };
            };
            for (var _i = 0, flips_1 = flips; _i < flips_1.length; _i++) {
                var flip = flips_1[_i];
                _loop_1(flip);
            }
            ...
            _this.tuning.onClick = function () {
                _this.basePitchGroup.enabled = _this.tuning.value;
                _this.mapVelToVolume.setEnabled(_this.tuning.value);
            };
            _this.mapVelToVolume.setEnabled(false);
            return _this;
        }
        ...
        ApplyEffectsTab.prototype._getCheckedChecks = function () {
            var check = this.getCheckedChecks();
            if (this.mapVelToOpacity.value)
                check.push(this.mapVelToOpacity);
            if (this.tuning.value && this.mapVelToVolume.value)
                check.push(this.mapVelToVolume);
            return check;
        };
    ...
    var MarkerConductor = /** @class */ (function (_super) {
        ...
        function MarkerConductor(parent) {
            ...
            _this.translate();
            setNumberEditText(_this.bpmTxt, { type: "decimal", min: 1 }, 120);
            _this.unitCombo.onChange = function () {
                ...
                setNumberEditText(_this.beatTxt, unitIndex === 0 ? { type: "int", min: 1 } : { type: "decimal" }, 4);
    ...
    (function (EaseType) {
         ...
         * 线性。
         */
        EaseType[EaseType["LINEAR"] = 3] = "LINEAR";
        /**
         * 定格两边。
         */
        EaseType[EaseType["HOLD"] = 4] = "HOLD";
        /**
         * 定格左边。
         */
        EaseType[EaseType["HOLD_IN"] = 5] = "HOLD_IN";
        /**
         * 定格右边。
         */
        EaseType[EaseType["HOLD_OUT"] = 6] = "HOLD_OUT";
    })(EaseType || (EaseType = {}));
    ...
    var Ease100Percent = /** @class */ (function (_super) {
        ...
        function Ease100Percent(parent) {
            ...
            _this.easeLinearRadio = addControl(_this.group, "radiobutton");
        ...
        Ease100Percent.prototype.getValue = function () {
            ...
            else if (this.easeLinearRadio.value)
                return EaseType$1.LINEAR;
            else if (this.easeHoldRadio.value)
                return EaseType$1.HOLD;
            else if (this.easeHoldInRadio.value)
                return EaseType$1.HOLD_IN;
            else if (this.easeHoldOutRadio.value)
                return EaseType$1.HOLD_OUT;
            else
    ...
    var BatchSubtitleGeneration = /** @class */ (function (_super) {
        __extends(BatchSubtitleGeneration, _super);
        //#endregion
        function BatchSubtitleGeneration(parent) {
            var _a;
            var _this = _super.call(this, parent) || this;
            ...
            setNumberEditText(_this.durationTxt, { type: "decimal", min: 0, minNeq: true }, 1);
            _this.translate();
            _this.browseButton.onClick = function () {
                var file = File.openDialog(localize(uiStr.open), localize(uiStr.text_document) + ":*.txt;*.text;*.log;*.md;*.lrc;*.srt," + localize(uiStr.all_files) + ":*.*");
                if (file === null)
                    return;
        ...
        return BatchSubtitleGeneration;
    }(BaseTool));
    ...
    var ToolsTab = /** @class */ (function (_super) {
        ...
        function ToolsTab(parent) {
            var _this = _super.call(this, parent, false, undefined, { orientation: "column", alignment: ["fill", "fill"], alignChildren: "fill", margins: [10, 5, 0, 0] }) || this;
            _this.disableSetLastTool = false;
            _this.toolsCombo = addControl(_this.group, "dropdownlist");
            _this.separator = new Separator(_this.group, "horizontal");
            _this.toolsPanel = addControl(_this.group, "group", { orientation: "stack", alignment: ["fill", "fill"], alignChildren: "fill" });
            _this.marker = new MarkerConductor(_this);
            _this.ease = new Ease100Percent(_this);
            _this.subtitle = new BatchSubtitleGeneration(_this);
            _this.toolsCombo.onChange = function () {
                ...
                _this.setLastTool(_this.toolsCombo.getSelectedIndex());
            };
            return _this;
        }
        ToolsTab.prototype.setLastTool = function (index) {
        ...
        ToolsTab.prototype.translate = function () {
            ...
            addItems(this.toolsCombo, localize(uiStr.marker_conductor), localize(uiStr.easing_100_percent), localize(uiStr.batch_subtitle_generation));
    ...
    var BpmKeysData = /** @class */ (function () {
        ...
        /** 方便调试 */
        BpmKeysData.prototype.toString = function () {
    ...
    (function (MetaEventType) {
        ...
        // 未定义
        MetaEventType[MetaEventType["UNDEFINED"] = 0] = "UNDEFINED";
    ...
    var MetaEvent = /** @class */ (function (_super) {
        ...
        function MetaEvent(type) {
            ...
            _this.type = MetaEventType.UNDEFINED;
            _this.type = type;
            return _this;
        }
        return MetaEvent;
    ...
    var SmpteOffsetMetaEvent = /** @class */ (function (_super) {
        ...
        function SmpteOffsetMetaEvent(smpteOffset) {
            ...
            _this.hour = smpteOffset[0], _this.min = smpteOffset[1], _this.sec = smpteOffset[2], _this.fr = smpteOffset[3], _this.subFr = smpteOffset[4];
            return _this;
        }
    ...
    var TimeSignatureMetaEvent = /** @class */ (function (_super) {
        ...
        function TimeSignatureMetaEvent(timeSignature) {
            ...
            _this.number = timeSignature[0], _this.denom = timeSignature[1], _this.metro = timeSignature[2], _this.thirtySeconds = timeSignature[3];
            return _this;
        }
    ...
    var NoteOnOffEvent = /** @class */ (function (_super) {
        ...
        function NoteOnOffEvent(type, channel, values) {
            ...
            _this.pitch = values[0], _this.velocity = values[1];
            return _this;
        }
    ...
    var NoteSecondEvent = /** @class */ (function (_super) {
        __extends(NoteSecondEvent, _super);
        function NoteSecondEvent(raw, startSecond) {
            var _this = _super.call(this) || this;
            assign(_this, raw);
            _this.startSecond = startSecond;
            return _this;
        }
        return NoteSecondEvent;
    }(NoteEvent));
    ...
    var DynamicBpmIntegrator = /** @class */ (function () {
        ...
        DynamicBpmIntegrator.prototype.getSecond = function (note) {
            ...
            if (note instanceof NoteOnEvent) {
                ...
                var result = new NoteSecondEvent(note, startSecond);
                return result;
            }
        };
        /**
    ...
    var Midi = /** @class */ (function () {
        ...
        Midi.prototype.displayBpm = function () {
            var DEFAULT_BPM = 120;
            if (!this.bpm)
                return String(DEFAULT_BPM);
            var result = String(this.bpm);
            if (this.isDynamicBpm)
                result += DYNAMIC_BPM_SIGN;
            return result;
        };
        return Midi;
    }());
    ...
    var SettingsDialog = /** @class */ (function () {
        ...
        function SettingsDialog(portal) {
            ...
            var about = localize(uiStr.about, User.githubPage, appDisplayName, BridgeTalk.appSpecifier, "v" + User.version);
            var translator = localize(uiStr.__translator__);
            if (translator !== "")
            ...
            (_a = addGroup(this.generalPanel, localize(uiStr.language), "dropdownlist", undefined, undefined, true), this.languageGroup = _a.group, this.languageLbl = _a.label, this.languageCombo = _a.control);
            ...
            this.importPureQuarterMidiBtn.onClick = function () {
                if (!confirm(localize(uiStr.sure_to_import_pure_quarter_midi), true, localize(uiStr.import_pure_quarter_midi)))
                    return;
                var midi = new Midi(true);
                _this.portal.midi = midi;
                ...
                _this.portal.updateDefaultBpm(midi);
            };
        ...
        SettingsDialog.langIso = ["", "zh_CN", "en", "ja", "vi", "ko"];
    ...
    var HFlipMotionType;
    (function (HFlipMotionType) {
        HFlipMotionType[HFlipMotionType["ENTRANCE"] = 0] = "ENTRANCE";
        HFlipMotionType[HFlipMotionType["EXIT"] = 1] = "EXIT";
        HFlipMotionType[HFlipMotionType["FLOAT_LEFT"] = 2] = "FLOAT_LEFT";
        HFlipMotionType[HFlipMotionType["FLOAT_RIGHT"] = 3] = "FLOAT_RIGHT";
        HFlipMotionType[HFlipMotionType["FLOAT_UP"] = 4] = "FLOAT_UP";
        HFlipMotionType[HFlipMotionType["FLOAT_DOWN"] = 5] = "FLOAT_DOWN";
    })(HFlipMotionType || (HFlipMotionType = {}));
    ...
    var Core = /** @class */ (function () {
        ...
        Core.prototype.applyCreateNullObject = function (comp) {
            ...
            var integrator = this.getIntegrator();
        ...
        Core.prototype.applyEffects = function (comp) {
            ...
            if (!this.portal.midi || this.portal.selectedTracks.length === 0)
                throw new NoMidiError();
            if (effectsTab._getCheckedChecks().length === 0)
                throw new NoOptionsCheckedError();
            ...
            var requireAdjustAnchor = optimize && (hFlipMotion === HFlipMotionType$1.FLOAT_LEFT || hFlipMotion === HFlipMotionType$1.FLOAT_RIGHT || hFlipMotion === HFlipMotionType$1.FLOAT_UP || hFlipMotion === HFlipMotionType$1.FLOAT_DOWN);
            var currentAnchor = [960, 540];
            ...
            var geometry2 = {
                ...
                opacity: function () { return this.prop().property(9); },
                anchor: function () { return this.prop().property(1); },
            };
            var isFlips = effectsTab.hFlip.value || effectsTab.vFlip.value || effectsTab.ccwFlip.value || effectsTab.cwFlip.value;
            if (isFlips || effectsTab.cwRotation.value || effectsTab.ccwRotation.value || effectsTab.mapVelToOpacity.value) {
                ...
                currentAnchor = layer.anchorPoint.value.slice(0, 2);
            }
            ...
            var addNoteEvent = function (noteEvent) {
                ...
                if (noteEvent instanceof NoteOnEvent) {
                    ...
                    var noteOffSeconds = void 0;
                    if (!noteSecondEvent) {
                        var duration = (_c = (_b = noteEvent.interruptDuration) !== null && _b !== void 0 ? _b : noteEvent.duration) !== null && _c !== void 0 ? _c : 0;
                        noteOffSeconds = (noteEvent.startTick + duration) * secondsPerTick - MIN_INTERVAL + startTime;
                    }
                    else
                        noteOffSeconds = ((_e = (_d = noteSecondEvent.interruptDurationSecond) !== null && _d !== void 0 ? _d : noteSecondEvent.durationSecond) !== null && _e !== void 0 ? _e : 0)
                    ...
                    if (isFlips) {
                        ...
                        var mod2 = noteOnCount % 2, mod4 = noteOnCount % 4;
                        var signs_bool = [!mod2, true];
                        ...
                        if (!optimize || !hasDuration || requireAdjustAnchor) {
                            ...
                            var increasedScale = currentScale + enterIncremental;
                            var value1 = [increasedScale * signs[0], increasedScale * signs[1]], value2 = [currentScale * signs[0], currentScale * signs[1]];
                            if (hFlipMotion === HFlipMotionType$1.EXIT)
                                _a = [value2, value1], value1 = _a[0], value2 = _a[1];
                        ...
                        if (requireAdjustAnchor && hasDuration) { // 调整锚点
                            var addKey_1 = function (seconds) { return !addToGeometry2 ? layer.anchorPoint.addKey(seconds) :
                                geometry2.anchor().addKey(seconds); };
                            var setValueAtKey_1 = function (keyIndex, value) {
                                return !addToGeometry2 ? layer.anchorPoint.setValueAtKey(keyIndex, value) :
                                    geometry2.anchor().setValueAtKey(keyIndex, value);
                            };
                            var setInterpolationTypeAtKey_1 = function (keyIndex, inType) {
                                return !addToGeometry2 ? layer.anchorPoint.setInterpolationTypeAtKey(keyIndex, inType) :
                                    geometry2.anchor().setInterpolationTypeAtKey(keyIndex, inType);
                            };
                            var setPointKeyEase_1 = function (keyIndex, easeType, isHold) {
                            ...
                            if (hFlipMotion === HFlipMotionType$1.FLOAT_LEFT || hFlipMotion === HFlipMotionType$1.FLOAT_RIGHT)
                                setValueAtKey_1(key_1, [currentAnchor[0] + direction * movement, currentAnchor[1]]);
                            else
                                setValueAtKey_1(key_1, [currentAnchor[0], currentAnchor[1] + direction * movement]);
                            setInterpolationTypeAtKey_1(key_1, KeyframeInterpolationType.LINEAR);
                            var key2 = addKey_1(noteOffSeconds);
                            setValueAtKey_1(key2, currentAnchor);
                            setPointKeyEase_1(key2, EaseType$1.EASE_IN, true);
                        }
                    }
                    if (effectsTab.cwRotation.value || effectsTab.ccwRotation.value) {
                    ...
                    if (effectsTab.mapVelToOpacity.value) {
                        var addKey = function (seconds) { return !addToGeometry2 ? layer.opacity.addKey(seconds) :
                            geometry2.opacity().addKey(seconds); };
                        var setValueAtKey = function (keyIndex, value) {
                            return !addToGeometry2 ? layer.opacity.setValueAtKey(keyIndex, value) :
                                geometry2.opacity().setValueAtKey(keyIndex, value);
                        };
                        var setInterpolationTypeAtKey = function (keyIndex, inType) {
                            return !addToGeometry2 ? layer.opacity.setInterpolationTypeAtKey(keyIndex, inType) :
                                geometry2.opacity().setInterpolationTypeAtKey(keyIndex, inType);
                        };
                        var value = effectsTab.mapVelToOpacity.map(noteEvent.velocity);
                        var key = addKey(seconds);
                        setValueAtKey(key, value);
                        setInterpolationTypeAtKey(key, KeyframeInterpolationType.HOLD);
                    }
                    ...
                    if (effectsTab.tuning.value && audioLayer) {
                        ...
                        if (effectsTab.mapVelToVolume.value) {
                            ...
                            var key_2 = audioLevels.addKey(seconds);
                            var value = effectsTab.mapVelToVolume.map(noteEvent.velocity);
                            audioLevels.setValueAtKey(key_2, [value, value]);
                            audioLevels.setInterpolationTypeAtKey(key_2, KeyframeInterpolationType.HOLD);
                            if (hasDuration) {
                                var key2 = audioLevels.addKey(noteOffSeconds);
                                var MIN_VOLUME = -192;
        ...
        Core.prototype.applyEase100Percent = function (comp) {
            ...
            for (var _i = 0, layers_1 = layers; _i < layers_1.length; _i++) {
                ...
                if (layer === undefined)
                    continue;
                var selectedProperties = Core.getSelectedProperties(layer);
                for (var _a = 0, selectedProperties_1 = selectedProperties; _a < selectedProperties_1.length; _a++) {
                    var property = selectedProperties_1[_a];
                    if (property === undefined)
                        continue;
                    for (var _b = 0, _c = property.selectedKeys; _b < _c.length; _b++) {
                        var keyIndex = _c[_b];
        ...
        Core.prototype.applyGenerateSubtitles = function (comp) {
            ...
            if (!subtitlesText.trim().length)
                throw new EmptySubtitlesError();
            var subtitles = subtitlesText.replace(/\r\n|\n\r|\r|\n/g, "\n").split("\n");
            app.beginUndoGroup("om midi - Apply Batch Subtitle Generation");
            var layer = comp.layers.addText();
            var startTime = layer.startTime = this.getStartTime(comp);
            subtitles.forEach(function (line, index) {
                if (!line.trim().length)
                    return;
         ...
         * @returns 选中的参数。
         */
        Core.getSelectedProperties = function (layer) {
            var properties = [];
            var propertyClasses = layer instanceof Array ? layer : layer.selectedProperties;
            for (var _i = 0, propertyClasses_1 = propertyClasses; _i < propertyClasses_1.length; _i++) {
                var property = propertyClasses_1[_i];
                if (property === undefined)
                    continue;
                    ...
                    properties.push.apply(properties, this.getSelectedProperties(subProperties));
                }
            }
            return properties;
        };
        ...
        Core.prototype.setPointKeyEase = function (property, keyIndex, easeType, isHold) {
            ...
            var original = [property.keyInInterpolationType(keyIndex), property.keyOutInterpolationType(keyIndex)];
    ...
    var MIDI_BUTTON_HEIGHT = 22;
    var MIDI_BUTTON_WIDTH = 15;
    var Portal = /** @class */ (function () {
        ...
        function Portal(window) {
            ...
            var FILL_CENTER = ["fill", "center"];
            (_a = addGroup(this.group, "", "button", { text: DIALOG_SIGN, size: [MIDI_BUTTON_WIDTH, MIDI_BUTTON_HEIGHT] }), this.selectMidiGroup = _a.group, this.selectMidiLbl = _a.label, this.selectMidiBtn = _a.control);
        ...
        Portal.prototype.displayBpmForNoBpm = function () {
            var bpm;
            try {
        ...
        Portal.prototype.updateDefaultBpm = function (midi) {
            var bpm = midi.bpm ? midi.displayBpm() : this.displayBpmForNoBpm();
            this.selectBpmTxt.text = bpm;
            setNumberEditText(this.selectBpmTxt, { type: "decimal", min: 1 }, bpm);
        };
        Portal.prototype.isUseDynamicBpm = function () {
