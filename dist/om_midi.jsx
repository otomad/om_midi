 ...
 *
 * 构建日期：2022 年 10 月 24 日 星期一 凌晨 0:14:11
 ...
 *
 * Building Date: Monday, October 24, 2022 12:14 AM
 * Copyright (c) 2022 ~, Ranne
 *
        ...
        var addNoteEvent = function (noteEvent) {
            ...
            if (noteEvent instanceof NoteOnEvent) {
                ...
                if (!noteSecondEvent) {
                    ...
                    noteOffSeconds = ((_d = (_c = noteSecondEvent.interruptDurationSecond) !== null && _c !== void 0 ? _c : noteSecondEvent.durationSecond) !== null && _d !== void 0 ? _d : 0)
